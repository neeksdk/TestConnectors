public class ConnectableStateStatic : ConnectableState
{
    ...
    private static bool _mouseClickOnConnectableComponent;
    ...
    public override void OnMouseEnter() {
        _mouseClickOnConnectableComponent = true;
    ...
    public override void OnMouseExit() {
        _mouseClickOnConnectableComponent = false;
    ...
    private void ConnectableMode(ConnectableComponentSphere connectableSphereClicked) {
        ...
        if (ConnectionModeIsOn) {
            ...
            ConnectableComponentSphereRef.SetMaterialColor(connectableSphereClicked == ConnectableComponentSphereRef ? Constants.SELECTED_CONNECTABLE_ACTIVE_COLOR : Constants.SELECTED_CONNECTABLE_INACTIVE_COLOR);
        }
    }

    public override void Update() {
        if (UnityEngine.Input.GetMouseButtonDown(0) && !_mouseClickOnConnectableComponent)
            OnSphereSelected(null);
    }
}
